...
import { supabase } from './supabaseClient.js'; // แก้เป็นจุดเดียวเพื่อให้หาไฟล์เจอ
...
const RequestRepair = () => {
  ...
  return (
    <div style={{ backgroundColor: '#000', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      <div style={{ backgroundColor: '#111', padding: '30px', borderRadius: '15px', border: '1px solid #333', width: '100%', maxWidth: '400px', color: '#fff' }}>
        <h2 style={{ textAlign: 'center', color: '#ff4d4d', marginBottom: '25px' }}>ฟอร์มแจ้งซ่อม</h2>
